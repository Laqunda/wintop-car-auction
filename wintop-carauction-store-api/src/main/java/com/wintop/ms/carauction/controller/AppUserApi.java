...
/**
 * Created by liangtingsen on 2018/3/14.
 * app卖家、中心用户接口
 */
@RestController
...
//            短信发送成功
            ...
            resultModel = new ResultModel(true, ResultStatus.SUCCESS,msgContext);
            responseEntity = new ResponseEntity<>(resultModel, HttpStatus.OK);
            }else {
                resultModel = new ResultModel(false, ResultStatus.ERROR);
                responseEntity = new ResponseEntity<>(resultModel, HttpStatus.OK);
    ...
    public ResponseEntity<ResultModel> checkMobile(@RequestParam String mobile) {

...
public class CurrentUserMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) {
        ...
        try {
            ...
            String appUserRedisKey = (String) webRequest.getAttribute(Constants.APP_USER_REDIS_KEY, RequestAttributes.SCOPE_REQUEST);
            Object redisAppUser = redisManagerTemplate.get(appUserRedisKey);
            if (redisAppUser != null) {
                result = redisAppUser;
            } else {
                if (currentUserId != null) {
                    ...
                    if (resultResponseEntity.getStatusCode() == HttpStatus.OK && "true".equals(serviceResult.get("success").toString())) {
                        ...
                        result = appUser;
                        redisManagerTemplate.add(appUserRedisKey,JSONObject.toJSONString(appUser));
                    } else {
                        result = null;
                    }
                }

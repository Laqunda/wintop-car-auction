...
public class CarChaboshiStoreAccountServiceImpl implements ICarChaboshiStoreAccountService {
    ...
    @Override
    public CarChaboshiStoreAccount selectCarChaboshiStoreAccount(CarChaboshiStoreAccount tmp) {
        List<CarChaboshiStoreAccount> accounts = selectCarChaboshiStoreAccountList(tmp);

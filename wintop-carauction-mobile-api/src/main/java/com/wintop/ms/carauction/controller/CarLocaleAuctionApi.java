...
public class CarLocaleAuctionApi {
    ...
    @RequestMapping(value = "/selectAuctionTotalList",
            ...
            consumes="application/json; charset=UTF-8",
            produces="application/json; charset=UTF-8")
    public ResponseEntity<ResultModel> selectAuctionTotalList(@RequestHeader Map<String,String> headers, @RequestBody Map<String,Object> map , @CurrentUserId AppUser user) {
        map.put("clientType","app");

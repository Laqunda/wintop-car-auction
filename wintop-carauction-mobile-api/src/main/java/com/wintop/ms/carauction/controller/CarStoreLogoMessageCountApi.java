...
public class CarStoreLogoMessageCountApi {
    ...
    @AuthUserToken
    public ResponseEntity<ResultModel> selectCarStoreLogoMessageCount(@CurrentUserId Long userId, @RequestBody Map<String,Object> map) throws MalformedURLException {
